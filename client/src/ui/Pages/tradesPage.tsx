...
const ReinforcementListingElement: React.FC = () => {
    ...
    return (
        <div style={{ width: "98%", height: "40px", backgroundColor: "#2F2F2F", display: "flex", flexDirection: "row", padding: "5px 5px", border: "3px #C0C0C0 solid",  textAlign: "center", color: "white", marginBottom: "25px" }}>
            <div style={{ height: "100%", width: "15%", display: "flex", justifyContent: "center", alignItems: "center" }}>Wallet Id</div>
