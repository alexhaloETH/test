...
//         for (const outpostHit of selectedEventData.outpost_hit_list) {
//             const outpost = getComponentValueStrict(contractComponents.Outpost, outpostHit);

//             const outpostX = outpost.x;
//             const outpostY = outpost.y;

//             // Check if the outpost is inside the event
//             const distance = Math.sqrt(Math.pow(outpostX - eventX, 2) + Math.pow(outpostY - eventY, 2));
//             if (distance <= eventRadius) {
//                 outpostHitList.push(outpostHit);
//             }
//         }
//     }, []);
...
//                         </div>
//                         <div style={{ height: "100%", whiteSpace: "nowrap", display: "flex", justifyContent: "center", alignItems: "center" }}>Event 82/891</div>
//                         <div style={{ height: "80%", aspectRatio: "1/1" }}>
