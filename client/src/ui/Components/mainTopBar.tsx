...
export const TopBarComponent: React.FC<TopBarPageProps> = ({ setGamePhase, phaseNum }) => {
    ...
    const [currentNumOfOutposts, setCurrentNumOfOutposts] = useState(100);
    const [maxNumOfOutpost, setMaxNumOfOutpost] = useState(2000);

    const [Jackpot, setJackpot] = useState(200);

    const [reinforcementsInGame, setReinforcementsInGame] = useState(64);
